...
<div class="container" id="destindex">
    <div>
    <div class="btn btn-success" data-target="#addBarangay" data-toggle="modal">Add</div>
    <hr>
    <div class="row">
...
@section('modals')
    <div class="modal fade" tabindex="-1" role="dialog" id="addBarangay">
        <div id="modal-dialog" class="modal-dialog  modal-md" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title"><i class="fa fa-trash"></i> Add new Barangay</h4>
                </div>
                <div class="modal-body">
                    <form class="form-horizontal" action="{{url('admin/province-save')}}" method="POST">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-10">
                                <input type="text" class="form-control" name="prov_name" placeholder="Barangay Name">
                            </div>
                        </div>
