...
<head>
  ...
  <!-- Font Awesome -->
  <link rel="stylesheet" href="{{ asset('admin_template/fonts/font-awesome.min.css')}}">
  <!-- Ionicons -->
  <link rel="stylesheet" href="{{ asset('admin_template/fonts/ionicons.min.css')}}">
  <!-- Theme style -->
...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="{{ route('admin.index') }}" class="logo">
      ...
      <span class="logo-lg">Bicol<b>Region</b></span>
    </a>
      ...
      <div class="navbar-custom-menu">
        <ul class="nav navbar-nav">
              ...
              <li>
                ...
                <ul class="menu">
                  <li><!-- start message -->
                    <a href="#">
                      <div class="pull-left">
                        <img src="{{ asset('admin_template/dist/img/18113378.jpg')}}" class="img-circle" alt="User Image">
                      </div>
                      <h4>
                        Support Team
          ...
          <li class="dropdown user user-menu">
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
              <img src="{{ asset('admin_template/dist/img/18113378.jpg')}}" class="user-image" alt="User Image">
              <span class="hidden-xs">Jerrold Verzosa </span>
            </a>
            <ul class="dropdown-menu">
              <!-- User image -->
...
{{--       <form action="#" method="get" class="sidebar-form">
      ...
      <ul class="sidebar-menu">
		...
		<li class="treeview"><a href="{{route('admin.index')}}"><i class="glyphicon glyphicon-dashboard"></i><span>Dashboard</span> </a></li>
        <li class="treeview">
          <a href="#">
            <i class="fa fa-circle-o" aria-hidden="true"></i> <span>Region</span>
		...
		<li><a href="{{route('official.index')}}"><i class="fa fa-user"></i> <span>Region Officials</span></a></li>

		<li><a href="{{route('article.index')}}"><i class="fa fa-newspaper-o"></i><span>Articles</span></a></li>

		<li><a href="{{route('event.index')}}"><i class="fa fa-calendar-o"></i><span>Events</span></a></li>
    ...
    <section class="content">
      ...
      <div class="box">
        <div class="box-header with-border">
          <h3 class="box-title">Bicol Region | @yield('maintenance_title')</h3>
